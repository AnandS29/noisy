...
pref_comparisons.train(
    total_timesteps=20_000_000,  # For good performance this should be 1_000_000
...
learner.learn(20_000_000)  # Note: set to 100000 to train a proficient expert

from stable_baselines3.common.evaluation import evaluate_policy

reward, _ = evaluate_policy(learner.policy, venv, 10, render=False)
print(reward)